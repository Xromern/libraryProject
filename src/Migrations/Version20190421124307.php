 ...
 */
final class Version20190421124307 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, writer_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, description VARCHAR(1200) DEFAULT NULL, number_pages INT NOT NULL, date DATE NOT NULL, cover_img VARCHAR(255) DEFAULT NULL, book_pdf VARCHAR(255) DEFAULT NULL, image VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_CBE5A3311BC7E6B6 (writer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
